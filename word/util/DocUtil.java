package com.gentlesoft.workform.word.util;

import com.gentlesoft.workform.word.util.data.BookMarks;
...
public class DocUtil {
    ...
    public static void inflateData(String templateDocPath, String toPath, Map<String,String> params) throws Exception {
        ...
        msWordTool.replaceBookMark(params);
    ...
    public static void main(String[] args) {
        ...
        map.put("address","add地址");
        map.put("company_address","北京百度");
        map.put("company_name","百度公司");
        map.put("customerName","小度");
        map.put("Principles","yuanze呀");
        map.put("Purpose","你的目的");
        map.put("Scope","全体范围");
        try {
            inflateData("F:/IdeaProjects/inflateTemplate/src/main/java/poi/Word.docx","d:/fuckk_after.docx",map);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
